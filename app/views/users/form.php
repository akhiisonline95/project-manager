...
<div class="main-content">
    ...
    <form id="userForm" method="post" novalidate action="<?= isset($projectData) ? 'index.php?controller=user&action=edit&id=' . $projectData['id'] : 'index.php?controller=user&action=create' ?>">
        <?php if ($userData): ?>
